...
export class SsoComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    if (vwSsoConfig?.autoRedirect && vwSsoConfig?.defaultIdentifier && qParams.identifier == null) {
